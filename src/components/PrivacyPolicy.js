...
const PrivacyPolicyComponent = () => {
  ...
  return (
      <div>
        <NavBar />
      <Container fluid className="bannerroad insideBanner">
        <div>
        <img src={require('../img/inside-banner.png')} alt={require('../img/inside-banner.png')}/>
        </div>
      </Container>
      <Container >
      ...
      <Container className="privacyTxt">
        ...
        <ul>
            ...
            <li>
                <strong>Application</strong> refers to Freelly, the software program provided by the Company.
            </li>
            <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CENTARA TECH VENTURE LTD., 70, Mohakhali, Dhaka.
            </li>
            <li>
        ...
        <section>
            ...
            <ul>
                <li>By email: <a href="mailto:info@centaratech.com">info@centaratech.com</a></li>
                <li>By visiting this page on our website: <a href="https://freelly-website.arodek.com/">https://freelly-website.arodek.com/</a></li>
                <li>By phone number: <a href="tel:01309002116">01309002116</a></li>
            </ul>
        </section>
      </Container>
      <Footer />
